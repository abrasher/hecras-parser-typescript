...
Note 1: I believe it is always a power, but HECRAS is inconsistent and _may_ break this rule somewhere but always assume it doesn't
...
They are instead surrounded by "BEGIN _PROPERTYNAME_:" and "END _PROPERTYNAME_:"
