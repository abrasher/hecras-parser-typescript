...
function main() {
  ...
  try {
    ...
    console.log("Parsing geometry data...")
    const geometryData = parseGeometry(originalContent)

    console.log("Serializing geometry data...")
    ...
    for (let i = 0; i < maxLines; i++) {
      ...
      if (i % 10000 === 0) {
        console.log(`  Progress: ${i}/${maxLines} lines processed`)
      }
    }
    ...
    console.log("5. Investigate stack overflow issues in 2D geometry parsing")
  } catch (error) {
