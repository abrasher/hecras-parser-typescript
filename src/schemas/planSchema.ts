...
export const planSchema = schema([
  ...
  numberField("wqOutputFaceFlow", "WQ Output face flow=", { integer: true, optional: true }),
  numberField("wqOutputFaceVelocity", "WQ Output face velocity=", {
    integer: true,
    optional: true,
  }),
  numberField("wqOutputFaceArea", "WQ Output face area=", { integer: true, optional: true }),
  numberField("wqOutputFaceDispersion", "WQ Output face dispersion=", {
    integer: true,
    optional: true,
  }),
  numberField("wqOutputCellVolume", "WQ Output cell volume=", { integer: true, optional: true }),
  numberField("wqOutputCellSurfaceArea", "WQ Output cell surface area=", {
    integer: true,
    optional: true,
  }),
  numberField("wqOutputCellContinuity", "WQ Output cell continuity=", {
    integer: true,
    optional: true,
  }),
  ...
  numberField("wqOutputFaceConc", "WQ Output face conc=", { integer: true, optional: true }),
  numberField("wqOutputFaceDconcDx", "WQ Output face dconc_dx=", {
    integer: true,
    optional: true,
  }),
  numberField("wqOutputFaceCourant", "WQ Output face courant=", { integer: true, optional: true }),
  numberField("wqOutputFacePeclet", "WQ Output face peclet=", { integer: true, optional: true }),
  numberField("wqOutputFaceAdvMass", "WQ Output face adv mass=", { integer: true, optional: true }),
  numberField("wqOutputFaceDispMass", "WQ Output face disp mass=", {
    integer: true,
    optional: true,
  }),
  numberField("wqOutputCellMass", "WQ Output cell mass=", { integer: true, optional: true }),
  numberField("wqOutputCellSourceSinkTemp", "WQ Output cell source sink temp=", {
    integer: true,
    optional: true,
  }),
  numberField("wqOutputNsmPathways", "WQ Output nsm pathways=", { integer: true, optional: true }),
  numberField("wqOutputNsmDerivedPathways", "WQ Output nsm derived pathways=", {
    integer: true,
    optional: true,
  }),
