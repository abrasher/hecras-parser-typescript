...
const indianaEast = '+proj=tmerc +lat_0=37.5 +lon_0=-85.6666666666667 +k=0.999966667 +x_0=99999.9998983998 +y_0=249999.9998984 +datum=NAD83 +units=us-ft +no_defs +type=crs';
...
export function coordinateArrayToLatLng(coords: { x: number; y: number }[]): LatLng[] {
