...
export class SectionDetector {
    ...
    detectSection(line: string, context: DetectionContext = {}): SectionMatch | null {
    ...
    private testRule(rule: SectionRule, line: string, context: DetectionContext): {
        confidence: number;
        metadata: Record<string, any>;
    } | null {
    ...
    private testPattern(pattern: SectionPattern, line: string): {
        confidence: number;
        metadata: Record<string, any>;
    } | null {
