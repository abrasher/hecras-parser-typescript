...
describe("Bridge Connection Unit Tests", () => {
  ...
  describe("Deck Parameters", () => {
    ...
    it("should parse deck upstream deck parameters", () => {
      expect(bridgeData.data.deckParameters.upstream).toEqual(
        testBridgeData.deckParameters.upstream,
      )
    })

    it("should parse downstream deck parameters", () => {
      expect(bridgeData.data.deckParameters.downstream).toEqual(
        testBridgeData.deckParameters.downstream,
      )
    })
  })
  ...
  describe("Bridge Sections", () => {
    it("should parse correct number of bridge sections", () => {
      expect(bridgeData.data.insideUpstreamCrossSection).toBeDefined()
      expect(bridgeData.data.insideDownstreamCrossSection).toBeDefined()
    })

    it("should parse first bridge section points", () => {
      const section1 = bridgeData.data.insideUpstreamCrossSection
      expect(section1.id).toBe(1)
      expect(section1.points).toHaveLength(62)
      expect(section1.points[0]).toEqual([0, 252.093])
      expect(section1.points[1]).toEqual([0.584, 252.088])
    })
    ...
    it("should parse second bridge section", () => {
      const section2 = bridgeData.data.insideDownstreamCrossSection
  ...
  describe("Cross Sections", () => {
    it("should parse correct number of cross sections", () => {
      expect(bridgeData.data.externalUpstreamCrossSection).toBeDefined()
      expect(bridgeData.data.externalDownstreamCrossSection).toBeDefined()
    })

    it("should parse first cross section", () => {
      const xs1 = bridgeData.data.externalUpstreamCrossSection
      expect(xs1.id).toBe(1)
      expect(xs1.points).toHaveLength(58)
      expect(xs1.points[0]).toEqual([0, 251.968])
    })

    it("should parse second cross section", () => {
      const xs2 = bridgeData.data.externalDownstreamCrossSection
