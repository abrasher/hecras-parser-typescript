...
describe.skip("River Reach Serializer Tests", () => {
  const testRiverReach: RiverReach = {
    ...
    coordinates: [
      ...
      [483652.389, 4753543.3606],
      [483653.0071, 4753542.5837],
      [483653.6252, 4753541.8069],
      [483654.2432, 4753541.0301],
      [483654.8613, 4753540.2533],
      [483655.4794, 4753539.4765],
      [483656.0974, 4753538.6997],
      [483656.7155, 4753537.9228],
      [483657.3336, 4753537.146],
      [483657.9516, 4753536.3692],
    ],
